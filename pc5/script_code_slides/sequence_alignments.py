...
def identity(seq1, seq2, alphabet = "ACGT"):
    ...
    sm = create_submat(2, -2, alphabet)
    print("-----------------")
    print(needleman_Wunsch(seq1, seq2, sm, -3))
    print("-----------------")
...
sm = create_submat(2, -1, "ATGC")
S, T = needleman_Wunsch(seq1, seq2, sm, -2)
print_mat(S)
print_mat(T)
print(S[-1][-1])
print(recover_align(T, seq1, seq2))

S, T, maxscore = smith_Waterman(seq1, seq2, sm, -2)
print_mat(S)
print_mat(T)
print(maxscore)
print(recover_align_local(S, T, seq1, seq2))